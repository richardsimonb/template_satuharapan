<div id="ctop-right">
	...
	<a href="https://bit.ly/penaburkidventure">
	   <img src="/fileadmin/banners/kidventurebpkpenabur.jpg" style="max-width:309px;"/>
	</a>
    </div>
...
<!-- sisipan galeri foto -->  
    ...
    ?>
	    ...
	    <div id="ctop-right-photo">
	        ...
	        ?>
			    <span class="img-thumb"><a title="<?=$contentsmash[0]['realtitle']?>" href="<?=baseURL.$link2smash.$contentsmash[0]['value_alias']?>"><img src="<?=PATH_image_cache."309x206_".$contentsmash[0]['image']?>" width="309" height="206" alt="<?=$contentsmash[0]['realtitle']?>" /></a></span>
	        <?php
		    }
		    ?>
                <div class="titlelatest">
    			    <h4><a title="<?=$contentsmash[0]['realtitle']?>" href="<?=baseURL.$link2smash.$contentsmash[0]['value_alias']?>"><?=$contentsmash[0]['title']?></a></h4>
			        <?=$contentsmash[0]['preview']?>
			        <a title="<?=$contentsmash[0]['realtitle']?>" href="<?=baseURL.$link2.$contentsmash[0]['value_alias']?>"><span class="more"></span></a>
		        </div>
    	    </div>
	        <div class="line"></div>
	    </div>
	    ...
	    ?>
			...
			$class="titlenophoto";
			if($image[0]!=""){?>
			    <span class="img-thumb"><a title="<?=$contentsmash[$m]['realtitle']?>" href="<?=baseURL.$link2smash.$contentsmash[$m]['value_alias']?>"><img src="<?=PATH_image_cache."150x100_".$image[0]?>" width="150" height="100" alt="<?=$contentsmash[$m]['realtitle']?>"/></a></span>
			<?php
			$class="titlephoto";
			}
			?>
			    <div class="<?=$class?>">
    				<a title="<?=$contentsmash[$m]['realtitle']?>" href="<?=baseURL.$link2smash.$contentsmash[$m]['value_alias']?>"><?=$contentsmash[$m]['title']?></a>
			    </div>
			    <div class="clear"></div>
		    </div>
