                ...
                <div class="headlinepag right">
                    ...
                    $gal_lain_ind = $koneksi2->query("SELECT *
                                            ...
                                            WHERE tt_news_cat.title =  'Galeri Foto Indonesia' 
                                                ...
                                                ORDER BY tt_news.uid 
                                                DESC LIMIT 0,5");
                    while ($fot_ind_lain = $gal_lain_ind->fetch_array()) {
                    $ind_image_lain = explode(',', $fot_ind_lain['image']);
                    ?>
                <div class="isidaftarbaru">
                    
                        <div class="fotodaftarbaru">                   
                            <img src= "uploads/cache/<?php echo "150x100_".$ind_image_lain[0] ?>">                      
                        </div>
