...
<div id="bingkaifotodetail">
				<div class="blueTitle">GALERI FOTO INDONESIA</div>
				<div id="headlinecontain" class="left">
					...
					?>
						<div class="listheadline">
							...
							$class="titleonly";
							if($image[0]!=""){?>
								<div class="imghead1"><a title="<?=$list['realtitle']?>" href="<?=baseURL?>/read-detail/read/<?=$list['value_alias']?>"><img src="<?=PATH_image_cache."469x312_".$image[0]?>" width="469" height="312" alt="<?=$list['realtitle']?>"></a></div>
							<?php
							$class="titlelatest";
							}
							?>
